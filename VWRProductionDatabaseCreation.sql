...
-- This section creates an empty database called VWRPrduction
USE master;
...
/*This section will create the database tables, the primary keys, foreign keys, constraints and indexes will be created with the tables*/
...
Like most tables within the database, the table contains nonclustered indexes. The number of nonclustered indexes are kept small whithin the tables 
...
/*This tables primary key will be assigned to the "ProductCategoryID" column and an index on the 'CategoryName' column*/
...
/*This will assist in enhanced retreivel of data associated with the three columns that make up the nonclustered objects*/
...
"Associates" table. Finally, the "ProductShipperID" column which will point to the "ProductShipperID" column on the "ProductShippers" table*/
...
in this case wil be "OrderID" and "ProductID". The foreign keys will be assigned to the "OrderID" and "ProductID" the first will point to the "CustomerOrders" table
...
the "UnitPrice" column values will be greater than or equal to 0.*/
