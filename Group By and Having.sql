--This code demonstrates the "Group By" & "Having"clauses.
...
--In this example, I demonstrate the use of the "HAVING" and "GROUP BY" clauses. This code displays the results by grouping 
