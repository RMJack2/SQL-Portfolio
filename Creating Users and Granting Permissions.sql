...
/*The code below grants permissins to users on specific databse (in this case the Production.ProductDetails table) objects*/
GRANT SELECT, UPDATE, INSERT, DELETE ON 
Production.ProductDetails TO Darrel;
/*Here, permissions are granted on the Sales.Customers table*/
